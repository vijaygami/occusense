...
void keyPressed()
{
  ...
  case ' ': 
    ...
    {  
      ...
      String[] savetodepthidentification = {nullPoint3d.x+","+nullPoint3d.y+","+nullPoint3d.z+","+
                                            xDirPoint3d.x+","+xDirPoint3d.y+","+xDirPoint3d.z+","+
                                            zDirPoint3d.x+","+zDirPoint3d.y+","+zDirPoint3d.z};
      saveStrings("../../../../../DepthIdentification/usercoordsys.txt",savetodepthidentification);
//      saveStrings("../../../../../DepthID2/usercoordsyspodium.txt",savetodepthidentification);
